...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Ipaudio-2024/main/ipaudiopro-py3.12_v1.1.tar.gz"
wait
tar -xzf ipaudiopro-py3.12_v1.1.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/ipaudiopro-py3.12_v1.1.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
